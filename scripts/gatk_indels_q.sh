...
usage="usage: $0 [<email address> (default: myourshaw@ucla.edu)] [<ref.fasta> | <ref.fa> (default human_g1k_v37.fasta)] <sample(s).gatk_ug_indels.vcf> [<bam file(s)>]";
here=$(dirname "$0");
...
name="gatkVariantFiltrationIndel_`basename $prefilteredVcf`";
cmd=" \
