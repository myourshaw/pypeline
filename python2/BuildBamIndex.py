...
class BuildBamIndexError(Exception): pass
...
def main():
	parser = argparse.ArgumentParser(
		description = 'wrapper for picard BuildBamIndex',
		epilog = 'pypeline.BuildBamIndex version 1.0β1 ©2011-2012 Michael Yourshaw all rights reserved')
	parser.add_argument('--input', '-i', nargs='+',
											help='list of sam/bam files to index',)
	...
	for i in args.input:
		picard.run('BuildBamIndex', email=args.email, debug=args.debug, synchronous=False, INPUT=i)
