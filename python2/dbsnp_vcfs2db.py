...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog = 'pypeline.dbsnp_vcfs2db version 1.0β1 ©2011-2014 Michael Yourshaw all rights reserved')
    ...
    with  open(db_output_file,'w') if args.uncompressed else gzip.open(db_output_file, 'w') as db_out:
