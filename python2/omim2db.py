...
def run(dir):
    ...
    genemap_in = os.path.join(dir, 'genemap')
    morbidmap_in = os.path.join(dir, 'morbidmap')
    mim2gene = os.path.join(dir, 'mim2gene.txt')
    if not (os.path.exists(dir) and os.path.exists(genemap_in)  and os.path.exists(morbidmap_in) and os.path.exists(mim2gene)):
    ...
    genemap_out = os.path.join(dir, 'omim_genemap.txt')
        ...
        for row in gm_in:
            ...
            for gene in genes:
                for disorder in disorders:
                    ...
                    gm_out.writerow(gm)
    morbidmap_out = os.path.join(dir, 'omim_morbidmap.txt')
