...
#
#  modelname.pdb must exist in working directory (case sensitive)
#
...
#    description = """Creates a single in silico point mutation to sidechain type and at residue position
#input by the user, in the structure whose file is modelname.pdb
#The conformation of the mutant sidechain is optimized by conjugate gradient and
#refined using some MD.""",
#    epilog = 'http://salilab.org/modeller/wiki/Mutate%20model')
#parser.add_argument('--modelname', required = True,
#    help='pdb model name e.g., 1t29')
#parser.add_argument('--respos', required = True,
#    help='residue position, e.g., 1699')
#parser.add_argument('--restyp', required = True,
#    help='sidechain residue type, e.g., LEU')
#parser.add_argument('--chain', default='',
#    help='chain, e.g., A. if the model has no chain identifier, specify "" for the chain argument.')
#parser.add_argument('--log',
#    help='output logfile')
#args = parser.parse_args()
#modelname, respos, restyp, chain, log = args.modelname, args.respos, args.restyp, args.chain, args.log
