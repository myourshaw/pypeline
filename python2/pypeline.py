    ...
    for readgroup in [r for r in readgroups if readgroups[r].readgroup_qseqs]:
        ...
        if rg.readgroup_qseqs and len(rg.readgroup_qseqs) > 0:
            ...
            if rg.additional_readgroup_description:
                rg.readgroup_description = rg.readgroup_description + rg.additional_readgroup_description + '' if rg.additional_readgroup_description.endswith(';') else ';'
...
def main():
    ...
    parser = argparse.ArgumentParser(parents=[my.default_parser()],
        ...
        epilog = 'pypeline.pypeline version 1.0β1 ©2011-2012 Michael Yourshaw all rights reserved')
