...
def run(vcfs,
    ...
    for vcf in vcfs:
        ...
        vex_metadata = [
        '##INFO=<ID=oALT,Number=1,Type=String,Description="Original VCF file\'s ALT field, which may contain multiple alleles">',
        ...
        gtx_metadata = [
        '##INFO=<ID=oALT,Number=1,Type=String,Description="Original VCF file ALT field, which may contain multiple alleles">',
