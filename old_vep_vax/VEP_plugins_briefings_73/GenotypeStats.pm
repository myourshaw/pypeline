...
sub get_header_info {
    ...
    return {
        GT_ALLELE_COUNT => "number of alleles in called genotypes (VCF)",
        GT_REF_ALLELE_COUNT => "number of reference alleles in called genotypes (VCF)",
        GT_ALT_ALLELE_COUNT => "number of alternate alleles in called genotypes (VCF)",
        GT_REF_ALLELE_FREQUENCY => "reference allele frequency in called genotypes (VCF)",
        GT_ALT_ALLELE_FREQUENCY => "alternate allele frequency in called genotypes (VCF)",
        GT_SAMPLE_COUNT => "number of samples in called genotypes (VCF)",
        GT_HET_SAMPLE_COUNT => "number of heterozygous samples in called genotypes (VCF)",
        GT_HOM_REF_SAMPLE_COUNT => "number of homozygous reference samples in called genotypes  (VCF)",
        GT_HOM_ALT_SAMPLE_COUNT => "number of homozygous alternate samples in called genotypes (VCF)",
    };
}
